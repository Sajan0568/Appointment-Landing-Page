...
export default function Home() {
  return <main>
    ...
    <footer className="footer"><img className="brand-logo footer-logo" src="/ChatGPT%20Image%20Jul%2031,%202026,%2008_29_23%20AM.png" alt="Sajan Clicks" /><p>Helping small and medium business owners use AI-powered marketing to attract, convert, and follow up with customers.</p></footer>
  </main>;
}
